...
//   ASSERT_EQ(dom6, dom2);
//   domain_type dom7(v3);
//   ASSERT_EQ(dom2 - dom1, dom7);
//   ASSERT_EQ(dom2 - dom7, dom1);
//   ASSERT_EQ(dom3 - v2, dom2);
//   ASSERT_EQ(dom2 + dom1 + dom3, dom3);

//   ASSERT_EQ(dom2.intersect(dom3), dom2);
//   domain_type dom9(v2, v3);
//   ASSERT_EQ(dom2.intersect(dom3), dom2);
//   ASSERT_EQ(dom2.intersect(dom7), dom7);
//   ASSERT_EQ(dom0.intersect(dom3), dom0);
//   ASSERT_EQ(dom2.intersect(dom9), dom7);
// }
...
//       asg < dom.end(); ++asg, ++i) {
//     ASSERT_EQ(asg.linear_index(), i);
//     ASSERT_EQ(asg.asg_at(0), asg.asg(1));
//     ASSERT_EQ(asg.asg_at(1), asg.asg(2));
//     ASSERT_EQ(asg.asg_at(2), asg.asg(3));
//     ASSERT_EQ(val[0], asg.asg(1));
//     ASSERT_EQ(val[1], asg.asg(2));
//     ASSERT_EQ(val[2], asg.asg(3));
...
//     ASSERT_EQ(rev_asg.asg(1), asg.asg(1));
//     ASSERT_EQ(rev_asg.asg(2), asg.asg(2));
//     ASSERT_EQ(rev_asg.asg(3), asg.asg(3));
//     ASSERT_EQ(rev_asg.linear_index(), asg.linear_index());
//     assignment_type other_asg = asg.restrict(sub_dom);
//     ASSERT_EQ(other_asg.asg(1), asg.asg(1));
//     ASSERT_EQ(other_asg.asg(3), asg.asg(3));
//     assignment_type asg3(dom);
//     asg3.set_asg(1, asg.asg(1));
//     asg3.set_asg(2, asg.asg(2));
//     asg3.set_asg(3, asg.asg(3));
//     ASSERT_EQ(asg3.asg(1), asg.asg(1));
//     ASSERT_EQ(asg3.asg(2), asg.asg(2));
//     ASSERT_EQ(asg3.asg(3), asg.asg(3));
//     domain_type dom2(v4, v5);
//     for(assignment_type asg2 = dom2.begin();  asg2 < dom2.end(); ++asg2) {
//       assignment_type joint = asg & asg2;
//       ASSERT_EQ(joint.asg(4), asg2.asg(4));
//       ASSERT_EQ(joint.asg(5), asg2.asg(5));
//     }

//     assignment_type asg4(sub_dom);
//     asg4.update(asg);
//     ASSERT_EQ(asg4, asg.restrict(sub_dom));
...
//   }
//   ASSERT_EQ(sum, sum2);
//   ASSERT_LT(std::abs(sum - 1), 1E-10);
   
//   for(assignment_type asg = dom.begin(); asg < dom.end(); ++asg) {
//     double val = double(rand()) / RAND_MAX;
//     factor.logP(asg) = val;
//     ASSERT_EQ(factor.logP(asg), 
...
//   for(assignment_type asg = dom.begin(); asg < dom.end(); ++asg) {
//     ASSERT_EQ(factor2.logP(asg)/2, factor.logP(asg));
//     ASSERT_EQ(factor3.logP(asg), factor.logP(asg));
//     ASSERT_EQ(factor2.logP(asg)/2, factor.logP(asg.linear_index()));
//     ASSERT_EQ(factor3.logP(asg), factor.logP(asg.linear_index()));
//   }
...
//     ASSERT_EQ(factor5.logP(i), factor4.logP(i));
//   }
...
//   for(size_t i = 0; i < counts.size(); ++i) {
//     ASSERT_LT(std::abs(factor.logP(i) -
//                                  counts.logP(i)) , 1E-2);
//   }

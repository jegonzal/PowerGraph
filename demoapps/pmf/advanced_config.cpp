...
void advanced_config::init_command_line_options(graphlab::command_line_options & clopts){
  ...
  clopts.attach_option("test2", &test2, test2, "have a second test file (for kdd cup 2012)");
  ...
  clopts.attach_option("subsample", &subsample, subsample, "Subsample to reduce dataset size. Value should be 0.0001 to 1. 1 Means no subsampling.");

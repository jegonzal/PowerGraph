...
class mmap_wrapper{ 
 public:
  /**
   * mmaps a file into memory
   * if pad > 0, the file will be padded so that it is at least "pad" bytes
   * if diskuncached is true, all writes to the mmapped location will not be cached but will

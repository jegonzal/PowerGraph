...
#ifndef GRAPHLAB_DISTRIBUTED_LOCKING_ENGINE_HPP
#define GRAPHLAB_DISTRIBUTED_LOCKING_ENGINE_HPP
...
#pragma omp parallel reduction(+:items_added)
    ...
    */
    ...
    void set_engine_options(const scheduler_options& opts) {
      const bool success = opts.get_int_option("maxdef", max_deferred_tasks);
      if(success) 
        std::cout << "Max deferred set at: " << max_deferred_tasks << std::endl;

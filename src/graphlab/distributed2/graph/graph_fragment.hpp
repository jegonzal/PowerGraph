...
namespace graphlab {
  ...
  namespace graph_fragment {
    ...
    struct description {
      ...
      vertex_id_t block_size;
      vertex_id_t block_remainder;
      ...
      vertex_id_t owning_block(vertex_id_t vid) const;
    ...
    struct vertex_record {
      ...
      std::vector<vertex_id_t> out_neighbors_blockid;
      
      std::vector<vertex_id_t> in_neighbors;
      std::vector<vertex_id_t> in_neighbors_blockid;
      ...
      void save(graphlab::oarchive& oarc) const {
        oarc << vid
             << vdata
             << out_neighbors
             << out_neighbors_blockid
             << in_neighbors
             << in_neighbors_blockid
             << in_edge_data;
      }      
      void load(graphlab::iarchive& iarc) {
        iarc >> vid

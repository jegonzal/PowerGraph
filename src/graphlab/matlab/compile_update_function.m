...
%   compile the following 3 binaries.
%
%   (OUTPUT_M_NAME)_save_graph is a mex library
%
%            (OUTPUT_M_NAME)_save_graph(VDATA, ADJ, EDATA, ...
...
%   is set stricter type checking will be used. See the README for details
%   on how the graph is described as well as thestructure of the 
%   OPTIONS parameter 
%
%   (OUTPUT_M_NAME)_load_graph is a mex library
%
%            [VDATA, ADJ, EDATA] = (OUTPUT_M_NAME)_load_graph(GRAPHFILE)
%
%   This function will deserialize the graph in GRAPHFILE and return the 
%   result in VDATA, ADJ, EDATA. See the README for details on how the 
%   graph is described.
%
%        
%            (OUTPUT_M_NAME)_binary is a standalone program
%
%   This program takes in the standard GraphLab command line options, 
%   (run (OUTPUT_M_NAME)_binary --help for details), as well two additional
%   options. 

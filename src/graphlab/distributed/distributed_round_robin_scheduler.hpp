/**
 * This class defines a basic distributed_round_robin_scheduler
 * written by Danny Bickson
 **/
#ifndef DISTR_RR_SCHEDULER_HPP
#define DISTR_RR_SCHEDULER_HPP
...
namespace graphlab {
  ...
  class distributed_round_robin_scheduler : public ischeduler<Graph> {
  public:
  ...
  public:
    distributed_round_robin_scheduler(iengine_type* engine, 
    ...
    ~distributed_round_robin_scheduler() { }

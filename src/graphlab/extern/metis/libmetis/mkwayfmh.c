 ...
 * George
 *
 * $Id: mkwayfmh.c,v 1.2 2002/08/10 06:29:33 karypis Exp $
 *
 */
...
**************************************************************************/
void MCRandom_KWayEdgeRefineHorizontal(CtrlType *ctrl, GraphType *graph, idxtype nparts, 
       float *orgubvec, idxtype npasses)
{
  idxtype i, ii, iii, j, jj, k, l, pass, nvtxs, ncon, nmoves, nbnd, myndegrees, same; 
  idxtype from, me, to, oldcut, gain;

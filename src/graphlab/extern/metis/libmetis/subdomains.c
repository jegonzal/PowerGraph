 ...
 * George
 *
 * $Id: subdomains.c,v 1.3 2003/07/31 06:04:52 karypis Exp $
 *
 */
...
**************************************************************************/
void Random_KWayEdgeRefineMConn(CtrlType *ctrl, GraphType *graph, idxtype nparts, float *tpwgts, float ubfactor, idxtype npasses, idxtype ffactor)
{
  idxtype i, ii, iii, j, jj, k, l, pass, nvtxs, nmoves, nbnd, tvwgt, myndegrees; 
  idxtype from, me, to, oldcut, vwgt, gain;
  idxtype maxndoms, nadd;
...
void MoveGroupMConn(CtrlType *ctrl, GraphType *graph, idxtype *ndoms, idxtype *pmat,
                    idxtype nparts, idxtype to, idxtype nind, idxtype *ind)
{

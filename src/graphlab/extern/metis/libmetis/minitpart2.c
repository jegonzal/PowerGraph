 ...
 * George
 *
 * $Id: minitpart2.c,v 1.3 2002/08/10 06:57:50 karypis Exp $
 *
 */
...
{
  idxtype i, ii, j, k, l, kwgt, nvtxs, nbnd, ncon, nswaps, from, to, pass, me, cnum, tmp, imin;

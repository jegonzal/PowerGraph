...
function update_topic(i, data) {
  ...
  var wc = topic.selectAll("text").data(data, function(d) {return d[0];});

  // update words that already exist
  wc.attr("class", "update")
    .transition()
    .duration(1000)
    .delay(200)
  ...
  var enters = wc.enter().append("text").attr("class", "enter")
